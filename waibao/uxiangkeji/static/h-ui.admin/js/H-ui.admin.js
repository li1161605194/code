...
/*创建iframe*/
function creatIframe(href, titleName, ifmid) {
    var topWindow = $(window.parent.document),
        show_nav = topWindow.find('#min_title_list'),
        iframe_box = topWindow.find('#iframe_box'),
    ...
    iframeBox.hide();
    iframe_box.append('<div class="show_iframe"><div class="loading"></div><iframe allowFullScreen=true id="' + ifmid + '" frameborder="0" src=' + href + '></iframe></div>');
