...
<link rel='stylesheet' type='text/css' href='http://www.lst1.cn/company/public/ui/v2/static/css/basic.css'>
...
<?php } ?>
<?php if($met_page){ if($met_page == 404){$met_page = "show";}  $page_css_time = filemtime(PATH_TEM."cache/".$met_page."_".$_M[lang].".css");?>
...
<?php endforeach;?>
                        ...
                        <?php }else{ ?>
                        <div class='h-100 text-xs-center font-size-20 vertical-align' m-id='met_download'><?php echo $lang['nodata'];?></div>
                        <?php } ?>
                        ...
                        <form class='sidebar-search' method='get' action="<?php echo $c['met_weburl'];?>search/search.php">
                            ...
                            <div class="form-group">
                                <div class="input-search">
                                    ...
                                    <input type="text" class="form-control" name="searchword" placeholder="<?php echo $lang['search_placeholder'];?>">
                                </div>
                            </div>
                        </form>
                            <?php if($lang['sidebar_downloadlist_ok']){ ?>
                        <div class="sidebar-news-list recommend">
                            <h3 class='m-0'><?php echo $lang['download_bar_list_title'];?></h3>
                            <ul class="list-group list-group-bordered m-t-10 m-b-0">
                                <?php
    $cid=$data['class1'];

    $num = $lang['sidebar_downloadlist_num'];
    $module = "";
    $type = $lang['download_bar_list_type'];
    $para = "";
    if(!$module){
        if(!$cid){
            $value = $m['classnow'];  
...
?>
                                <li class="list-group-item">
                                    <a href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" target='_self'><?php echo $v['title'];?></a>
                                </li>
                                <?php endforeach;?>
                            </ul>
                        </div>
                        <?php } ?>
                            ...
                            <?php if($lang['downloadsidebar_column_ok']){ ?>
...
?>
                            <li>
                                <a href="<?php echo $m['url'];?>" title="<?php echo $m['name'];?>" class="<?php echo $m['class'];?>" target='_self'><h3><?php echo $m['name'];?></h3></a>
                            </li>
                            <?php
    $type=strtolower(trim('son'));
    $cid=$m['id'];
...
?>
                            <li>
                                    <?php if($m['sub'] && $lang['download_column3_ok']){ ?>
                                <a href="javascript:;" title="<?php echo $m['name'];?>" class='<?php echo $m['class'];?>' data-toggle="collapse" data-target=".sidebar-column3-<?php echo $m['_index'];?>"><?php echo $m['name'];?><i class="wb-chevron-right-mini"></i></a>
                                <div class="sidebar-column3-<?php echo $m['_index'];?> collapse" aria-expanded="false">
                                    <ul class="m-t-5 p-l-20">
                                        <li><a href="<?php echo $m['url'];?>" title="<?php echo $lang['all'];?>" class="<?php echo $m['class'];?>"><?php echo $lang['all'];?></a></li>
                                        <?php
    $type=strtolower(trim('son'));
    $cid=$m['id'];
    $column = load::sys_class('label', 'new')->get('column');
    ...
    foreach($result as $index=>$m):
        ...
        $$m = $m;
?>
                                        <li><a href="<?php echo $m['url'];?>" title="<?php echo $m['name'];?>" class='<?php echo $m['class'];?>'><?php echo $m['name'];?></a></li>
                                        <?php endforeach;?>
                                    </ul>
                                </div>
                                <?php }else{ ?>
