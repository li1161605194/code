...
?><?php endforeach;?>
                            <?php if($sub){ ?>
                        <ul class="ulstyle met-pager-ajax imagesize" data-scale='<?php echo $c['met_newsimg_y'];?>x<?php echo $c['met_newsimg_x'];?>'>
                            <?php defined('IN_MET') or exit('No permission'); ?>
<?php
    $cid = 0;
    if($cid == 0){
            ...
            <div class="row">
                <div class="met-bar" m-id="news_bar" m-type="nocontent">
                    ...
                    <div class="sidebar-news-list recommend">
                        <h3 class=' font-weight-300 m-0'><?php echo $lang['news_bar_list_title'];?></h3>
                        <ul class="list-group list-group-bordered m-t-10 m-b-0">
                            <?php
    $cid=$data['class1'];

    $num = $lang['news_bar_list_num'];
    $module = "";
...
?>
                        <li>
                            <a href="<?php echo $m['url'];?>" title="<?php echo $m['name'];?>" class="<?php echo $m['class'];?>" target='_self'><h3 class="font-weight-300"><?php echo $m['name'];?></h3></a>
                        </li>
                        <?php
    $type=strtolower(trim('son'));
    $cid=$m['id'];
