...
function(e, t) {
    ...
    e.DtPicker = e.Class.extend({
        init: function(n) {
            ...
            s.cancel.addEventListener("tap", function() {
                ...
                (a.options.beginMonth || a.options.endMonth) && a._createMinutes()
                    //alert(a.getSelected());
                    //alert(s.h.picker.getSelectedItem().text);
            }, !1), s.i.addEventListener("change", function(e) {
                (a.options.beginMonth || a.options.endMonth)
                //alert(a.getSelected());
                //alert(s.i.picker.getSelectedItem().text);
        ...
        getChangeItem: function() {
            return {
                "dtv": this.getSelected().value,
                "dtt": this.getSelected().text,
                "y": this.ui.y.picker.getSelectedItem(),
                "m": this.ui.m.picker.getSelectedItem(),
                "d": this.ui.d.picker.getSelectedItem(),
                "h": this.ui.h.picker.getSelectedItem(),
                "i": this.ui.i.picker.getSelectedItem()
            }
        },
        show: function(i) {
            var n = this,
