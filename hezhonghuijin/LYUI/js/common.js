...
var common = {
    ...
    initCommonFooterHtml: function() {
        var html = '<div class="weui-tabbar">' +
            '<a href="javascript:;" rel="views/index.html" class="weui-tabbar__item">' +
            '<span style="display: inline-block;position: relative;">' +
            '<img src="' + rootDirectory + 'img/tabbar/1001.svg" alt="" class="weui-tabbar__icon">' +
            '<span class="" style="position: absolute;top: -2px;right: -13px;"></span>' +
            '<span class=" weui-badge_dot" style="position: absolute;top: 0;right: -6px;"></span>' +
            '</span>' +
            '<p class="weui-tabbar__label">首页</p>' +
            '</a>' +
            '<a href="javascript:;" rel="users/service/service.html" class="weui-tabbar__item">' +
            '<span style="display: inline-block;position: relative;">' +
            '<img src="' + rootDirectory + 'img/tabbar/2001.svg" alt="" class="weui-tabbar__icon">' +
            '<span class="" style="position: absolute;top: -2px;right: -13px;"></span>' +
            '<span class=" weui-badge_dot" style="position: absolute;top: 0;right: -6px;"></span>' +
            '</span>' +
            '<p class="weui-tabbar__label">服务</p>' +
            '</a>' +
            '<a href="javascript:;" rel="users/my_center/my-center.html" class="weui-tabbar__item">' +
            '<span style="display: inline-block;position: relative;">' +
            '<img src="' + rootDirectory + 'img/tabbar/3001.svg" alt="" class="weui-tabbar__icon">' +
            '<span class="" style="position: absolute;top: -2px;right: -13px;"></span>' +
            '<span class=" weui-badge_dot" style="position: absolute;top: 0;right: -6px;"></span>' +
            '</span>' +
        ...
        $(".weui-tab_panel").append('<div class="tabbarhmb"></div>');
    },
    footerXuanz: function(num) {
        $(".weui-tabbar__item").removeClass("weui-bar__item_on");
        $(".weui-tabbar__item").eq(num).addClass("weui-bar__item_on");
        var src = $(".weui-tabbar__item").eq(num).find("img").attr("src");
        $(".weui-tabbar__item").eq(num).find("img").attr("src", src.split("1.")[0] + "2.svg");
    },
    bodyShow: function() {
    ...
    showResult: function(resultParam) {
        if (resultParam != undefined && typeof(resultParam) == "object") {
            resultParam.title = $("title").html().split("-")[1];
            resultParam.orgname = $("title").html().split("-")[0];
...
var wx_titie = {
    titleRewrite: function(title) {
        ...
        $("h2.navbar-title.navbar-center").html('<img class="loginimg_c" src="' + BaseUrl.IMGPATH +
            'loginimg.png">' + wxCompany + ' - ' + title);
    }
}

r_post_jsons = function(url, datas, callback) {
    if (AjaxUrl == undefined) {
        AjaxUrl = "https://m.hzqcjt.com/";
    }
    var load = layer.open({
        type: 2,
        content: '加载中'
...
var pullDownUp = {
    id: $("#mui-scroll"),
    downupHTML: function() {},
    init: function(downHTML, upHTML) {
        pullDownUp.downupHTML.prototype.downHTML = downHTML;
        pullDownUp.downupHTML.prototype.upHTML = upHTML;

    },
    pulldownRefresh: function() {
        setTimeout(function() {
            pullDownUp.id.html(pullDownUp.downupHTML.prototype.downHTML);
    ...
    pullupRefresh: function() {
        setTimeout(function() {
            ...
            pullDownUp.id.append(pullDownUp.downupHTML.prototype.upHTML);
        }, 1500);
    }
}
...
$(function() {
    mui.init({
        ...
        pullRefresh: {
            ...
            down: {
                callback: pullDownUp.pulldownRefresh
            },
            up: {
                contentrefresh: '正在加载...',
                callback: pullDownUp.pullupRefresh
            }
        }
    });
    wx_titie.titleRewrite(initParams.title);
