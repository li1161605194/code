...
_V_.Player = _V_.Component.extend({
  ...
  getVideoTagSettings: function(){
    ...
    options.poster = unescape(this.tag.getAttribute("poster"));
...
//document.getElementById("ad").innerText=(this.techGet("currentTime") || 0);
...
_V_.TextArea = _V_.Component.extend({

  createElement: function(){
    return this._super("div", {
      className: "vjs-textarea",
      innerHTML: "<marquee style='width:100%;height:30px;' scrollamount='2' direction='left' ><h1 id='ad'></h1></marquee>"
    });
  }
});
      ...
      if (vid && vid.getAttribute) {
        ...
        if (vid.player === undefined) {
          ...
          if (options !== null) {
            ...
            document.getElementById("ad").innerText=vid.getAttribute("adtitle");
          }
        }
